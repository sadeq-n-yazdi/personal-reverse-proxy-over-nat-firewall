...
This directory contains configuration files for Certbot, which is used to get and renew SSL/TLS certificates.
...
This file should have permissions set to 600 (read/write for the owner only) for security:
